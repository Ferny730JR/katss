/*
  ...
  gengetopt --input=kstruct.ggo --file-name=kstruct_cmdl --include-getopt --default-optional --unamed-opts --func-name=kstruct_cmdline_parser --arg-struct-name=kstruct_args_info
...
const char *kstruct_args_info_purpose = "A method for finding the average base-pair probability of all kmers in dataset";

const char *kstruct_args_info_usage = "Usage: kstruct [OPTIONS] [<input.fa>] [<bound.fa>]";

const char *kstruct_args_info_versiontext = "";

const char *kstruct_args_info_description = "The Base-Pair Probability Pipeline is a C program designed to analyze RNA\nsequences and identify enriched base-pair interactions in  protein-bound RNA.\nIt follows a structured pipeline that includes RNA folding, k-mer counting, and\nenrichment analysis, producing a CSV file with ranked k-mers based on their\nlikelihood of being bound or unbound.";

const char *kstruct_args_info_detailed_help[] = {
  ...
  "  -o, --output=filename    Set the name of the output files.  (default=`rna')",
...
{
  kstruct_args_info_help[0] = kstruct_args_info_detailed_help[0];
  kstruct_args_info_help[1] = kstruct_args_info_detailed_help[1];
  kstruct_args_info_help[2] = kstruct_args_info_detailed_help[2];
  kstruct_args_info_help[3] = kstruct_args_info_detailed_help[3];
  kstruct_args_info_help[4] = kstruct_args_info_detailed_help[4];
  kstruct_args_info_help[5] = kstruct_args_info_detailed_help[5];
  kstruct_args_info_help[6] = kstruct_args_info_detailed_help[7];
  kstruct_args_info_help[7] = kstruct_args_info_detailed_help[9];
  kstruct_args_info_help[8] = kstruct_args_info_detailed_help[11];
  kstruct_args_info_help[9] = kstruct_args_info_detailed_help[13];
  kstruct_args_info_help[10] = kstruct_args_info_detailed_help[15];
  kstruct_args_info_help[11] = kstruct_args_info_detailed_help[17];
  kstruct_args_info_help[12] = kstruct_args_info_detailed_help[18];
  kstruct_args_info_help[13] = kstruct_args_info_detailed_help[19];
  kstruct_args_info_help[14] = 0; 
  
}

const char *kstruct_args_info_help[15];

typedef enum {ARG_NO
  , ARG_STRING
  , ARG_INT
} kstruct_cmdline_parser_arg_type;

static
void clear_given (struct kstruct_args_info *args_info);
static
void clear_args (struct kstruct_args_info *args_info);

static int
kstruct_cmdline_parser_internal (int argc, char **argv, struct kstruct_args_info *args_info,
                        struct kstruct_cmdline_parser_params *params, const char *additional_error);
...
void clear_args (struct kstruct_args_info *args_info)
{
  ...
  args_info->output_arg = gengetopt_strdup ("rna");
...
static
void init_args_info(struct kstruct_args_info *args_info)
{

  init_help_array(); 
  args_info->help_help = kstruct_args_info_detailed_help[0] ;
  args_info->detailed_help_help = kstruct_args_info_detailed_help[1] ;
  args_info->version_help = kstruct_args_info_detailed_help[2] ;
  args_info->test_help = kstruct_args_info_detailed_help[5] ;
  args_info->control_help = kstruct_args_info_detailed_help[7] ;
  args_info->output_help = kstruct_args_info_detailed_help[9] ;
  args_info->kmer_help = kstruct_args_info_detailed_help[11] ;
  args_info->threads_help = kstruct_args_info_detailed_help[13] ;
  args_info->delimiter_help = kstruct_args_info_detailed_help[15] ;
  args_info->seq_windows_help = kstruct_args_info_detailed_help[19] ;
  
}

void
kstruct_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(KSTRUCT_CMDLINE_PARSER_PACKAGE_NAME) ? KSTRUCT_CMDLINE_PARSER_PACKAGE_NAME : KSTRUCT_CMDLINE_PARSER_PACKAGE),
     KSTRUCT_CMDLINE_PARSER_VERSION);

  if (strlen(kstruct_args_info_versiontext) > 0)
    printf("\n%s\n", kstruct_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(kstruct_args_info_purpose);
	size_t len_usage = strlen(kstruct_args_info_usage);

	if (len_usage > 0) {
		printf("%s\n", kstruct_args_info_usage);
	}
	if (len_purpose > 0) {
		printf("%s\n", kstruct_args_info_purpose);
	}
	...
	if (strlen(kstruct_args_info_description) > 0) {
		printf("%s\n\n", kstruct_args_info_description);
	}
}

void
kstruct_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (kstruct_args_info_help[i])
    printf("%s\n", kstruct_args_info_help[i++]);
}

void
kstruct_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (kstruct_args_info_detailed_help[i])
    printf("%s\n", kstruct_args_info_detailed_help[i++]);
}

void
kstruct_cmdline_parser_init (struct kstruct_args_info *args_info)
{
...
void
kstruct_cmdline_parser_params_init(struct kstruct_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
kstruct_cmdline_parser_params_create(void)
{
  struct kstruct_cmdline_parser_params *params = 
    (struct kstruct_cmdline_parser_params *)malloc(sizeof(struct kstruct_cmdline_parser_params));
  kstruct_cmdline_parser_params_init(params);  
  return params;
}
...
static void
kstruct_cmdline_parser_release (struct kstruct_args_info *args_info)
{
  unsigned int i;
  free_string_field (&(args_info->test_arg));
  free_string_field (&(args_info->test_orig));
  free_string_field (&(args_info->control_arg));
  free_string_field (&(args_info->control_orig));
...
int
kstruct_cmdline_parser_dump(FILE *outfile, struct kstruct_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", KSTRUCT_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->control_given)
    write_into_file(outfile, "control", args_info->control_orig, 0);
...
int
kstruct_cmdline_parser_file_save(const char *filename, struct kstruct_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", KSTRUCT_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = kstruct_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
kstruct_cmdline_parser_free (struct kstruct_args_info *args_info)
{
  kstruct_cmdline_parser_release (args_info);
}
...
int
kstruct_cmdline_parser (int argc, char **argv, struct kstruct_args_info *args_info)
{
  return kstruct_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
kstruct_cmdline_parser_ext (int argc, char **argv, struct kstruct_args_info *args_info,
                   struct kstruct_cmdline_parser_params *params)
{
  int result;
  result = kstruct_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
kstruct_cmdline_parser2 (int argc, char **argv, struct kstruct_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct kstruct_cmdline_parser_params params;
...
int
kstruct_cmdline_parser_required (struct kstruct_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see kstruct_cmdline_parser_params.check_ambiguity
 * @param override @see kstruct_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               kstruct_cmdline_parser_arg_type arg_type,
...
int
kstruct_cmdline_parser_internal (
  int argc, char **argv, struct kstruct_args_info *args_info,
                        struct kstruct_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct kstruct_args_info local_args_info;
  ...
  if (initialize)
    kstruct_cmdline_parser_init (args_info);

  kstruct_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVt:c:o:k:d:w::", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          kstruct_cmdline_parser_print_help ();
          kstruct_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          kstruct_cmdline_parser_print_version ();
          kstruct_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 't':	/* Read the protein bound RNA sequences file..  */
          ...
          break;
        case 'c':	/* Read the controls sequences file..  */
        
        
          if (update_arg( (void *)&(args_info->control_arg), 
        ...
        case 'o':	/* Set the name of the output files..  */
          ...
          if (update_arg( (void *)&(args_info->output_arg), 
              ...
              &(local_args_info.output_given), optarg, 0, "rna", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "output", 'o',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            kstruct_cmdline_parser_print_detailed_help ();
            kstruct_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", KSTRUCT_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  kstruct_cmdline_parser_release (&local_args_info);
